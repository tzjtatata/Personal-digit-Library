...
public class ReverseSet {
    ...
    protected File ft = new File("main/backtable/txtFolder/");
    ...
    public void printf() throws IOException {
        ...
        /*Node NODE;
         ...
         for (i = 0;i<length;i++) {
         NODE = List.get(i);
         File f = new File("main/backtable/workInfo/"+NODE.value+".pdl");
        ...
        /*
         ObjectOutputStream f1 = new ObjectOutputStream(new FileOutputStream("main/backtable/dic.pdl"));
         ObjectOutputStream f2 = new ObjectOutputStream(new FileOutputStream("main/backtable/data.pdl"));
         for (i = 0;i<count;i++) {
