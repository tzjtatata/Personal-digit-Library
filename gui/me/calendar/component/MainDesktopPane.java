...
public class MainDesktopPane extends JDesktopPane{
	...
	void init()
	{
	     ...
	     indexButton();
	     //initNow();
	     Icon icon=new ImageIcon(System.getProperty("java.class.path")+"/source/主页_背景.png","");  //设置背景 
	...
	void initButtons()
	{
		 ...
		 Icon i1=new ImageIcon(System.getProperty("java.class.path")+"/source/清除.png","");
		 Icon i2=new ImageIcon(System.getProperty("java.class.path")+"/source/储存.png","");
		 Icon i3=new ImageIcon(System.getProperty("java.class.path")+"/source/查询.png","");
